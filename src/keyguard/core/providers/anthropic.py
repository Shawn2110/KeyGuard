"""Anthropic provider — creates, tests, revokes, and lists Anthropic API keys."""
...
_ADMIN_BASE = f"{_API_BASE}/organizations/default/api_keys"


@register
class AnthropicProvider(Provider):
    """Anthropic. Admin-scoped key required for create/revoke/list."""
    ...
    def create_key(self, existing_key: str, label: str) -> ProviderKey:
        ...
        return ProviderKey(
            ...
            value=SecretStr(str(data.get("key", data.get("value", "")))),
